...
public class Rombo extends Rectangulo
{
    ...
    public Rombo(int x, int y, int ancho, int alto, Color colorBorde, Color colorRelleno,
            int tamanhio){
    ...
    public void iniciar()
    {
        int x = getX();
        int y = getY();
        int puntosX[] = { x+(int) Math.round( (double) ( (double)getAncho() / (double)2 ) ), x, x+(getAncho()/2), x+getAncho() };
        int puntosY[] = {y, y+(int) Math.round( (double) ( (double)getAlto() / (double)2 ) ), y+getAlto(), y+(int) Math.round( (double) ( (double)getAlto() / (double)2 ) ) };
